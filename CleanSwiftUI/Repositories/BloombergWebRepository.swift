...
protocol BloombergWebRepository: WebRepository {
    func loadCountries() -> AnyPublisher<[Country], Error>
    func loadCountryDetails(country: Country) -> AnyPublisher<Country.Details.Intermediate, Error>
}

struct RealBloombergWebRepository: BloombergWebRepository {
...
extension RealBloombergWebRepository {
    enum API {
        case allCountries
...
extension RealBloombergWebRepository.API: APICall {
    var path: String {
        switch self {
        case .allCountries:
            return "/all"
